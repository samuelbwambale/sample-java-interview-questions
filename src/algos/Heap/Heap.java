...
public class Heap {
    ...
    private Hashtable<Object, Node> locator = new Hashtable<Object, Node>();
    ...
    private void innerInsertItem(Node parent, Object key) {
    ...
    public void deleteItem(Object key) {
        ...
        if (nodeToDelete == null) throw new NoSuchElementException("Item to delete does not exist in heap");
        else {
            //upHeap(nodeToDelete);
    ...
    private void upHeap(Node n) {
        ...
        while (currentNode.parent != null) {
            key1 = (Comparable) currentNode.key;
            key2 = (Comparable) currentNode.parent.key;
    ...
    private void downHeapAfterDeleteItem(Node d) {
        ...
        while (currentNode.left != null || currentNode.right != null) {
            if (currentNode.right != null) {
                Node semiMin = null;
                key1 = (Comparable) currentNode.left.key;
                key2 = (Comparable) currentNode.right.key;
                if (key1.compareTo(key2) < 0) semiMin = currentNode.left;
                else semiMin = currentNode.right;
                key1 = (Comparable) semiMin.key;
                key2 = (Comparable) currentNode.key;
                if (key1.compareTo(key2) < 0) {
