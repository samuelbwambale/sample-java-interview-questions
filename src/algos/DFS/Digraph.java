...
public class Digraph {
	...
	public boolean reaches(Vertex u, Vertex v) {
		DirectedPathExist directedPathExist = new DirectedPathExist(this);
		return directedPathExist.reaches(u,v);
	}
	...
	public List<Vertex> reachable(Vertex u) {
		Reachable subDigraph = new Reachable(this);
		return subDigraph.reachable(u);
	}
